...
def test_part06_to_part08_notebook_inventory():
    expected = {
        "part06_kb_dashboard": [
            "01_eda.ipynb",
...
def test_part06_visualization_notebook_is_valid_json():
    path = PROJECTS / "part06_kb_dashboard" / "notebooks" / "03_chart_prototype.ipynb"
