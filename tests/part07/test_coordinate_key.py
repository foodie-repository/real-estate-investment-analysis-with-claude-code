"""
좌표 수집과 Part07 조인이 도로명주소 키를 일관되게 쓰는지 검증한다.
...
def test_part07_pivot_joins_coordinates_by_region_qualified_key(tmp_path, monkeypatch):
    from projects.part07_trade_map.dashboard import db
