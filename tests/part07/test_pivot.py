...
class TestRegionOptions:
    ...
    def test_매매_지역옵션(self):
        from projects.part07_trade_map.dashboard.preprocessing import get_region_options
    ...
    def test_연도범위(self):
        from projects.part07_trade_map.dashboard.preprocessing import get_year_range
