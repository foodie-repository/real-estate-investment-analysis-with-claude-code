...
from projects.part06_kb_dashboard.dashboard.db import execute_query, relation_exists
...
def get_all_indicators(year: int, month: int) -> dict[str, pd.DataFrame]:
    ...
    from projects.part06_kb_dashboard.dashboard.constants import INDICATORS
