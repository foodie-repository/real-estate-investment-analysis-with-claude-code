...
실행: uv run streamlit run projects/part06_kb_dashboard/dashboard/app.py
"""
import sys
...
from projects.part06_kb_dashboard.dashboard.constants import (
    SIDO_MAPPING, INDICATORS, MAP_LAYOUT,
)
from projects.part06_kb_dashboard.dashboard.geo import (
    load_geojson, filter_by_sido, get_sido_list, get_sigungu_list,
    get_sig_cd_for_names,
)
from projects.part06_kb_dashboard.dashboard.preprocessing import (
    get_all_indicators, get_timeseries, get_timeseries_sido, get_ts_date_range,
)
from projects.part06_kb_dashboard.dashboard.choropleth import (
    create_base_map, create_data_layer,
)
from projects.part06_kb_dashboard.dashboard.charts import (
