...
실행: uv run streamlit run projects/part07_trade_map/dashboard/app.py
"""
import sys
...
from projects.part07_trade_map.dashboard.preprocessing import (
    get_region_options, get_year_range, get_max_세대수,
)
from projects.part07_trade_map.dashboard.pivot import generate_pivot_table
from projects.part07_trade_map.dashboard.map_builder import (
    create_ranking_map, aggregate_by_complex,
)
from projects.part07_trade_map.dashboard.constants import (
    면적대_목록, 평형대_목록, 연식_색상,
)
